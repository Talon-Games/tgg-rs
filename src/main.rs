...
pub fn main() {
    ...
    //
    // horizontal_clues.push(CrosswordClue::new(1, Direction::Across, "XY"));
    // horizontal_clues.push(CrosswordClue::new(
    //     4,
    //     Direction::Across,
    //     "Front of a building",
    // ));
    // horizontal_clues.push(CrosswordClue::new(5, Direction::Across, "Very small"));
    // horizontal_clues.push(CrosswordClue::new(6, Direction::Across, "Shrek"));
    // horizontal_clues.push(CrosswordClue::new(
    //     7,
    //     Direction::Across,
    ...
    // ));
    //
    // vertical_clues.push(CrosswordClue::new(
    //     1,
    //     Direction::Down,
